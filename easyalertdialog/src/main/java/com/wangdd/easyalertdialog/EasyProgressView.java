...
public class EasyProgressView extends View {
    private static final String TAG = EasyProgressView.class.getSimpleName();
    ...
    /**
     * The constructor for the EasyProgressView
     *
     * @param context
     * @param attrs
     */
    public EasyProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.EasyProgressView));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.EasyProgressView_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.EasyProgressView_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.EasyProgressView_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.EasyProgressView_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.EasyProgressView_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.EasyProgressView_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = getResources().getColor(R.color.progress_material);
        barColor = a.getColor(R.styleable.EasyProgressView_barColor, barColor);

        rimColor = a.getColor(R.styleable.EasyProgressView_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.EasyProgressView_linearProgress, false);

        if (a.getBoolean(R.styleable.EasyProgressView_progressIndeterminate, false)) {
            spin();
        }
